...
from .matchers_v3 import from_term_v3


class MessagePactV3(Broker):
    """
    ...
    def with_metadata(self, metadata):
        ...
        """
        self._insert_message_if_complete()
        self._messages[0]['metaData'] = from_term_v3(metadata)
    ...
    def with_content(self, contents):
        ...
        self._messages[0]['contents'] = from_term_v3(contents)
        return self

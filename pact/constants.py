...
should these be unavailable or the environment variable `USE_SYSTEM_PACT` is
...
_USE_SYSTEM_PACT = os.getenv("USE_SYSTEM_PACT", "").upper() in ("TRUE", "YES")
...
def _find_executable(executable: str) -> str:
    ...
    This inspects the environment variable `USE_SYSTEM_PACT` to determine
